...
-- Copiando dados para a tabela sparqbd.parque: ~3 rows (aproximadamente)
INSERT INTO `parque` (`id_parque`, `nome_parque`, `longitude`, `latitude`, `area`) VALUES
	...
	(3, 'Parque Exemplo 3', -46.63500000, -23.55250000, _binary 0x0000000001030000000100000005000000e17a14ae475147c03d0ad7a3708d37c045d8f0f44a5147c03d0ad7a3708d37c045d8f0f44a5147c005c58f31778d37c0e17a14ae475147c005c58f31778d37c0e17a14ae475147c03d0ad7a3708d37c0);
...
-- Copiando dados para a tabela sparqbd.usuario: ~10 rows (aproximadamente)
INSERT INTO `usuario` (`id_usuario`, `nome`, `email`, `cpf`, `sexo`, `id_parque`, `senha`, `cargo`, `avatar`, `created_at`, `ativo`) VALUES
	(1, 'Exemplo', 'exemplo@email.com', '111.111.111-11', 'masculino', 1, '123456', 1, 'avatar.png', '2025-09-03 21:42:59', 1),
	(2, 'Jane Doe', 'jane.doe@email.com', '222.222.222-22', 'feminino', 2, 'senha456', 0, 'avatar.png', '2025-09-03 22:31:33', 1),
	(3, 'John Smith', 'john.smith@email.com', '333.333.333-33', 'masculino', 1, 'admin123', 1, 'avatar.png', '2025-09-03 22:31:33', 1),
	(4, 'Maria Silva', 'maria.silva@email.com', '444.444.444-44', 'feminino', 3, 'senha789', 0, 'avatar.png', '2025-09-03 22:31:33', 1),
	(30, 'Pedro Martins', 'pedro.martins@email.com', '555.555.555-55', 'masculino', 1, 'senha123', 0, 'avatar.png', '2025-09-03 22:31:33', 1),
	(31, 'Ana Clara', 'ana.clara@email.com', '666.666.666-66', 'feminino', 3, 'senha456', 1, 'avatar.png', '2025-09-03 22:31:33', 1),
	(32, 'Carlos Rocha', 'carlos.rocha@email.com', '777.777.777-77', 'masculino', 2, 'senha789', 0, 'avatar.png', '2025-09-03 22:31:33', 1),
	(33, 'Isabela Fernandes', 'isabela.f@email.com', '888.888.888.-8', 'feminino', 1, 'senhaabc', 0, 'avatar.png', '2025-09-03 22:31:33', 1),
	(34, 'Ricardo Gomes', 'ricardo.g@email.com', '999.999.999-99', 'masculino', 2, 'senhadef', 0, 'avatar.png', '2025-09-03 22:31:33', 1),
	(35, 'Fernanda Lima', 'fernanda.lima@email.com', '010.101.010-10', 'feminino', 3, 'senhaghi', 0, 'avatar.png', '2025-09-03 22:31:33', 1);
